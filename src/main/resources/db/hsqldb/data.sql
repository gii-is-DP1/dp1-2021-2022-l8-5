...
INSERT INTO games(currentPlayer,currentPhase,currentRound,firstPlayer,secondPlayer,thirdPlayer,startDate,finishDate,canResolveActions) VALUES (2,'ACTION_SELECTION',6,3,1,2,'2021-11-12 16:42:00', '2021-11-12 17:42:00',true);
 ...
 -- Card sheet 1
 -- INSERT INTO mountain_cards(name, description, xposition, yposition, type, cardgroup, image, actiontype) VALUES ('Orc Raiders', 'If undefended at the end of the round, players cannot take any MINE actions', 1, 0, 'DEFEND', 1, '/resources/images/mountainCards/orcRaiders/orcRaiders.png', 'ORC_RAIDERS');
 -- INSERT INTO mountain_cards(name, description, xposition, yposition, type, cardgroup, image, actiontype) VALUES ('Knockers', 'If undefended at the end of the round, each player must return 1 iron to the supply', 2, 0, 'DEFEND', 1, '/resources/images/mountainCards/knockers/knockers.png', 'DRAGONS_KNOCKERS');
 -- INSERT INTO mountain_cards(name, description, xposition, yposition, type, cardgroup, image, actiontype) VALUES ('Great Dragon', 'If undefended at the end of the round, each player must return all gold they possess to the supply', 2, 0, 'DEFEND', 1, '/resources/images/mountainCards/dragons/dragon.png', 'DRAGONS_KNOCKERS');
