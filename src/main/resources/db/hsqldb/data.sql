...
INSERT INTO games(currentPlayer,currentPhase,currentRound,firstPlayer,secondPlayer,thirdPlayer,startDate,finishDate,canResolveActions) VALUES (2,'ACTION_SELECTION',6,3,1,2,'2021-11-12 16:42:00', '2021-11-12 17:42:00',true);
 ...
 INSERT INTO mountain_cards(name, description, xposition, yposition, type, cardgroup, image, actiontype) VALUES ('Get Help', '2 adittional workers will help you this round by placing themselves on random tiles. If you are the first player, the next player will become the first one', 3, 1, 'AID', 3, '/resources/images/mountainCards/getHelps/getHelp.png', 'GET_HELP');
 ...
 INSERT INTO mountain_cards(name, description, xposition, yposition, type, cardgroup, image, actiontype) VALUES ('Get Help', '2 adittional workers will help you this round by placing themselves on random tiles. If you are the first player, the next player will become the first one', 2, 1, 'AID', 3, '/resources/images/mountainCards/getHelps/getHelp2.png', 'GET_HELP');
 ...
 INSERT INTO mountain_cards(name, description, xposition, yposition, type, cardgroup, image, actiontype) VALUES ('Get Help', '2 adittional workers will help you this round by placing themselves on random tiles. If you are the first player, the next player will become the first one', 3, 0, 'AID', 3, '/resources/images/mountainCards/getHelps/getHelp3.png', 'GET_HELP');
 INSERT INTO mountain_cards(name, description, xposition, yposition, type, cardgroup, image, actiontype) VALUES ('Gold Seam', 'Take 1 gold from the supply', 1, 1, 'MINE', 2, '/resources/images/mountainCards/goldSeams/goldSeam5.png', 'SEAM');
 INSERT INTO mountain_cards(name, description, xposition, yposition, type, cardgroup, image, actiontype) VALUES ('Gold Seam', 'Take 1 gold from the supply', 2, 1, 'MINE', 3, '/resources/images/mountainCards/goldSeams/goldSeam6.png', 'SEAM');
 INSERT INTO mountain_cards(name, description, xposition, yposition, type, cardgroup, image, actiontype) VALUES ('Knockers', 'If undefended at the end of the round, each player must return 1 iron to the supply', 3, 1, 'DEFEND', 3, '/resources/images/mountainCards/knockers/knockers2.png', 'DRAGONS_KNOCKERS');
 ...
 INSERT INTO mountain_cards(name, description, xposition, yposition, type, cardgroup, image, actiontype) VALUES ('Alloy Steel', 'Return 3 iron to the supply then take 2 steel', 2, 2, 'MINE', 2, '/resources/images/mountainCards/alloySteels/alloySteel6.png', 'FORGES_ALLOY');
 ...
 -- Card sheet 6
 INSERT INTO mountain_cards(name, description, xposition, yposition, type, cardgroup, image, actiontype) VALUES ('Gold Seam', 'Take 1 gold from the supply', 1, 0, 'MINE', 2, '/resources/images/mountainCards/goldSeams/goldSeam7.png', 'SEAM');
 INSERT INTO mountain_cards(name, description, xposition, yposition, type, cardgroup, image, actiontype) VALUES ('Sidhe', 'If undefended at the end of the round, each player must replace two gold they posesss with two iron', 2, 0, 'DEFEND', 2, '/resources/images/mountainCards/sidhes/sidhe3.png', 'SHIDE');
 ...
 INSERT INTO mountain_cards(name, description, xposition, yposition, type, cardgroup, image, actiontype) VALUES ('Get Help', '2 adittional workers will help you this round by placing themselves on random tiles. If you are the first player, the next player will become the first one', 1, 2, 'AID', 2, '/resources/images/mountainCards/getHelps/getHelp4.png', 'GET_HELP');
 INSERT INTO mountain_cards(name, description, xposition, yposition, type, cardgroup, image, actiontype) VALUES ('Knockers', 'If undefended at the end of the round, each player must return 1 iron to the supply', 2, 2, 'DEFEND', 2, '/resources/images/mountainCards/knockers/knockers4.png', 'DRAGONS_KNOCKERS');
